/*------------------<CIS 278 Assignment 11>----------------
    * Student: Zhili Wang
    * Due Date: Oct 30th 2018
    * Instructor: Dave Harden
    * Course: CIS 278
    * Number of Problem(s): 1
    * File Name: fraction.cpp
    * Implementing Fraction class
---------------------------------------------------------*/
...
public:
    ...
    friend ostream& operator << (ostream& out, const Fraction &right); // friend function
    friend istream& operator >> (istream& in, Fraction &right); // friend function
...
Fraction operator / (const Fraction &left, const Fraction &right) {
    ...
    tempFrac.numerator = left.numerator * right.denominator;
    tempFrac.denominator = left.denominator * right.numerator;
...
istream& operator >> (istream& strm, Fraction &obj) {
    char dummy;
    strm >> obj.numerator >> dummy >> obj.denominator;
    return strm;
